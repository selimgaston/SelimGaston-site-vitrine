export const profile = {
  artistName: "Selim Gaston",
  tagline: "Progressive, Afro House, Melodic House and Indie Dance.",
  ...
  stats: [
    ...
    { value: "Groove", label: "organic rhythms" },
    { value: "Story", label: "immersive sets" }
  ],
  services: ["Progressive House", "Afro House", "Melodic House", "Indie Dance", "DJ sets", "Production"]
};
